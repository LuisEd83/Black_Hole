...
namespace BH {
    ...
    */
    ...
    constexpr double Z_COEF = 0.7;
    
    constexpr double x_multiplier = 0.0;
    constexpr double y_multiplier = 0.0;
    constexpr double z_multiplier = 0.0;

    constexpr double x_bias = 0.0;
    constexpr double y_bias = 0.0;
    constexpr double z_bias = 0.0;
